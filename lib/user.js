...
User.configPath = function() {
	return path.join(User.storagePath(), "mnet_config.json");
};

User.persistPath = function() {
	return path.join(User.storagePath(), "mnet_persist");
};
...
User.LogHomebridgeMNETSTarts = function() {
	var startLogPath = path.join(this.storagePath(),"homebridge-mnet.startlog");
	var startLog = {};
